...
TELEGRAM_BOT_TOKEN=getenv("TELEGRAM_BOT_TOKEN", "1450402032:AAFilQj1KK1lEfdXsZ3yFaLxMKnTcdYOvEU") # <-- Configure here
TELEGRAM_CHAT_ID=getenv("TELEGRAM_CHAT_ID", "1001214686441") # <-- Configure here
